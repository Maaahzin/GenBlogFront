                ...
                <Grid alignItems="center" item xs={12}>
                 <Box className='box1'>
                        ...
                        <Box  display="flex" alignItems="center" justifyContent="center">
                            <a className="hover" href="https://www.facebook.com/maaahzin/" target="_blank">
                            <FacebookIcon className='redes' />
                            </a>
                            <a className="hover" href="https://www.instagram.com/maaahzin/" target="_blank">
                            <InstagramIcon className='redes' />
                            </a>
                            <a className="hover" href="https://www.linkedin.com/in/mariana-souza-339757148/" target="_blank">
                            <LinkedInIcon className='redes' />
                            </a>
                            <a className="hover" href="https://github.com/Maaahzin" target="_blank">
